"""
Django settings for sweet_night_dev_67846 project.
...
ROOT_URLCONF = 'sweet_night_dev_67846.urls'
...
WSGI_APPLICATION = 'sweet_night_dev_67846.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_night_dev_67846 API",
    "DESCRIPTION": "API documentation for sweet_night_dev_67846 App",
    "VERSION": "v1",
}
